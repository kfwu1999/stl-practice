...
public:
     ...
     */
    // clang-format off
    reference       front()       noexcept { return p_elem[0]; }
    const_reference front() const noexcept { return p_elem[0]; }
    // clang-format on
     ...
     */
    // clang-format off
    reference       back()       noexcept { return p_elem[_Size - 1]; }
    const_reference back() const noexcept { return p_elem[_Size - 1]; }
    // clang-format on
