 ...
 * \tparam _Compare: Comparison functor type, defaults to `std::less<>` for max
 * heap.
 */
...
public:
     ...
     */
    priority_queue() : m_container(container_type()), m_comp(value_compare()) {}
    ...
    /**
     * \brief Constructs the priority_queue from a range and an optional
     * comparison functor.
     *
...
public:
     ...
     *
     * \tparam Args: Variadic template arguments corresponding to the
     * constructor of the element type. \param args: Arguments to forward to the
